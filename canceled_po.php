...
<?php
  ...
  if(empty($errors)){
        $sql = "DELETE FROM detil_po WHERE id_po='{$id_po}'";
        $sql2 = "DELETE FROM po WHERE id_po='{$id_po}'";
     $result = $db->query($sql);
    ...
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="delete_po" class="btn btn-danger"><i class="fa fa-danger"></i> Delete</button>
        </div>
      </form>
    </div>
  </div>
