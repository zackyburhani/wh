...
<?php
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
	 ...
	 $p_ware   = remove_junk($db->escape($_POST['product-warehouse']));
     ...
     $query .=" name,quantity,buy_price,sale_price,categorie_id,date,warehouse_id";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$date}', '{$p_ware}'";
     $query .=")";
     if($db->query($query)){
